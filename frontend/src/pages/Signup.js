  ...
  return (
    <div className='fixed left-0 top-0 h-full w-full'>
      <div className='flex flex-col items-center justify-center h-full text-center content-center'>
        ...
        <button className='bg-black bg-opacity-5 hover:bg-opacity-10 backdrop backdrop-blur-sm border border-gray-500 my-2 rounded-lg p-2' onClick={handleSignup}>Sign Up</button>
        <p>
